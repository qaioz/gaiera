  ...
  const reviews = [
    {
      ...
      rating: 5,
      text: "GaiEra არის ფანტასტიკური ინსტრუმენტი! ძალიან ადვილია გამოყენება და მნიშვნელოვნად გააუმჯობესა ჩემი სამუშაო პროცესი. ძალიან რეკომენდებულია ყველასთვის, ვინც ცდილობს გააუმჯობესოს თავისი პროდუქტიულობა!",
    ...
    },
    {
      ...
      avatar: "/placeholder.svg?height=60&width=60",
      rating: 5,
      text: "შესანიშნავად გამოიყურება! მთავარი გვერდიდანვე ჩანს, რომ ეს არის ვიჯეტებზე დაფუძნებული ვებსაიტის შემქმნელი.",
      platform: "Product Hunt",
    },
    {
      name: "ლევანი",
      avatar: "/placeholder.svg?height=60&width=60",
      rating: 5,
      text: "ახლახანს აღმოვაჩინე ეს საოცარი ინსტრუმენტი Product Hunt-ზე. არაჩვეულებრივია!",
      platform: "Product Hunt",
    },
  ]
  ...
  return (
    <section className="bg-gray-100 h-full flex items-center">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl font-bold mb-8">საზოგადოება</h2>
          ...
          <div className="space-y-4">
            <div className="bg-white p-4 rounded-lg shadow-sm">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="font-medium">შემოგვიერთდით</h3>
              </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="font-medium">ჩატი</h3>
              </div>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="font-medium">ელფოსტა</h3>
              </div>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm">
              ...
              <p className="text-sm font-medium">შემოგვიერთდით</p>
